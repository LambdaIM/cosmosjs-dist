...
var Field = ts_amino_1.Amino.Field,
  ...
  marshalJson = ts_amino_1.Amino.marshalJson;
...
var StdTx = /** @class */ (function() {
  ...
  __decorate([Field.Defined(1)], StdTx.prototype, "fee", void 0);
  __decorate(
  ...
  __decorate([Field.String(3)], StdTx.prototype, "memo", void 0);
  StdTx = __decorate([DefineStruct()], StdTx);
  return StdTx;
})();
exports.StdTx = StdTx;
...
var StdFee = /** @class */ (function() {
  ...
  __decorate([Field.Uint64(1)], StdFee.prototype, "gas", void 0);
  StdFee = __decorate([DefineStruct()], StdFee);
  return StdFee;
})();
...
var StdSignDoc = /** @class */ (function() {
  function StdSignDoc(
    ...
    this.feeRaw = new RawMessage(
      buffer_1.Buffer.from(marshalJson(fee), "utf8")
    );
    this.memo = memo;
    this.msgsRaws = [];
  ...
  __decorate([Field.String(3)], StdSignDoc.prototype, "memo", void 0);
  __decorate(
  ...
  __decorate([Field.Uint64()], StdSignDoc.prototype, "sequence", void 0);
  StdSignDoc = __decorate([DefineStruct()], StdSignDoc);
  return StdSignDoc;
})();
...
var StdSignature = /** @class */ (function() {
  ...
  StdSignature = __decorate([DefineStruct()], StdSignature);
  return StdSignature;
})();
